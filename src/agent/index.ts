...
import { checkBalance } from "../tools/checkBalance.js";
import { payMerchant, payMerchantById } from "../tools/payMerchant.js";
import { activateInternet } from "../tools/activateInternet.js";
import { fetchWithPayment } from "../x402/client.js";
import { getMarketPrices, getHubLiquidity, executeArbitrage, injectLiquidity } from "../tools/arbitrage.js";
